...
: ${AMENT_CURRENT_PREFIX:="/home/samar/takwa_ws/install/pkg-nav"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pkg-nav/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pkg-nav/environment/path.sh"
