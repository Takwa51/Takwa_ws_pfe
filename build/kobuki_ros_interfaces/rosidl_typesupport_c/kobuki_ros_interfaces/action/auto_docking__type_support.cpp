...
static const _AutoDocking_SendGoal_Event_type_support_symbol_names_t _AutoDocking_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kobuki_ros_interfaces, action, AutoDocking_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kobuki_ros_interfaces, action, AutoDocking_SendGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kobuki_ros_interfaces, action, AutoDocking_SendGoal_Event)() {
  return &::kobuki_ros_interfaces::action::rosidl_typesupport_c::AutoDocking_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t AutoDocking_SendGoal_service_type_support_handle = {
  ...
  &AutoDocking_SendGoal_Request_message_type_support_handle,
  &AutoDocking_SendGoal_Response_message_type_support_handle,
  &AutoDocking_SendGoal_Event_message_type_support_handle,
...
static const _AutoDocking_GetResult_Event_type_support_symbol_names_t _AutoDocking_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kobuki_ros_interfaces, action, AutoDocking_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kobuki_ros_interfaces, action, AutoDocking_GetResult_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kobuki_ros_interfaces, action, AutoDocking_GetResult_Event)() {
  return &::kobuki_ros_interfaces::action::rosidl_typesupport_c::AutoDocking_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t AutoDocking_GetResult_service_type_support_handle = {
  ...
  rosidl_typesupport_c__get_service_typesupport_handle_function,
  &AutoDocking_GetResult_Request_message_type_support_handle,
  &AutoDocking_GetResult_Response_message_type_support_handle,
  &AutoDocking_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    kobuki_ros_interfaces,
    action,
